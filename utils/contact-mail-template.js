export function mailTemplate(fullName, email, phoneNumber, subject, message) {
  return `
    <!doctype html>
<html>
  <head>
    ...
    <title>Enquiry email from ${fullName}</title>
    <style>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                        ...
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Myself ${fullName},</p>
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Phone Number: ${phoneNumber},</p>
                            ...
                            <tr>
                              <td align="left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;">
                                <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;">
                                  <tbody>
                                    <tr>
                                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; background-color: #cb0c9f; border-radius: 5px; text-align: center;"> <a href="mailto: ${email}" target="_blank" style="display: inline-block; color: #ffffff; background-color: #cb0c9f; border: solid 1px #cb0c9f; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-transform: capitalize; border-color: #cb0c9f;">Mail to ${fullName}</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
